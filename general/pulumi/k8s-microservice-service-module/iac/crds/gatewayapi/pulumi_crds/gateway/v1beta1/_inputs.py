...
__all__ = [
    ...
    'ReferenceGrantSpecFromPatchArgsDict',
    'ReferenceGrantSpecFromArgs',
    'ReferenceGrantSpecFromArgsDict',
    'ReferenceGrantSpecPatchArgs',
    'ReferenceGrantSpecPatchArgsDict',
    'ReferenceGrantSpecToPatchArgs',
    'ReferenceGrantSpecToPatchArgsDict',
    'ReferenceGrantSpecToArgs',
    'ReferenceGrantSpecToArgsDict',
    'ReferenceGrantSpecArgs',
    'ReferenceGrantSpecArgsDict',
    'ReferenceGrantArgs',
    'ReferenceGrantArgsDict',
]
...
if not MYPY:
    class ReferenceGrantSpecFromPatchArgsDict(TypedDict):
        """
    ...
    ReferenceGrantSpecFromPatchArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ReferenceGrantSpecFromPatchArgs:
    def __init__(__self__, *,
                 group: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 namespace: Optional[pulumi.Input[str]] = None):
        ...
        :param pulumi.Input[str] group: Group is the group of the referent.
               ...
               Support: Core
        :param pulumi.Input[str] kind: Kind is the kind of the referent. Although implementations may support
               additional resources, the following types are part of the "Core"
               support level for this field.
...
if not MYPY:
    class ReferenceGrantSpecFromArgsDict(TypedDict):
        """
        ReferenceGrantFrom describes trusted namespaces and kinds.
        """
        group: NotRequired[pulumi.Input[str]]
    ...
    ReferenceGrantSpecFromArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class ReferenceGrantSpecPatchArgsDict(TypedDict):
        """
        Spec defines the desired state of ReferenceGrant.
        """
        from_: NotRequired[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromPatchArgsDict']]]]
        """
        ...
        Support: Core
        """
        to: NotRequired[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToPatchArgsDict']]]]
        """
    ...
    ReferenceGrantSpecPatchArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ReferenceGrantSpecPatchArgs:
    def __init__(__self__, *,
                 from_: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromPatchArgs']]]] = None,
                 to: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToPatchArgs']]]] = None):
        """
        Spec defines the desired state of ReferenceGrant.
        :param pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromPatchArgs']]] from_: From describes the trusted namespaces and kinds that can reference the
               resources described in "To". Each entry in this list MUST be considered
               to be an additional place that references can be valid from, or to put
               this another way, entries MUST be combined using OR.
               
               Support: Core
        :param pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToPatchArgs']]] to: To describes the resources that may be referenced by the resources
               described in "From". Each entry in this list MUST be considered to be an
               additional place that references can be valid to, or to put this another
               way, entries MUST be combined using OR.
    ...
    @property
    @pulumi.getter(name="from")
    def from_(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromPatchArgs']]]]:
        """
        From describes the trusted namespaces and kinds that can reference the
        resources described in "To". Each entry in this list MUST be considered
        to be an additional place that references can be valid from, or to put
    ...
    @from_.setter
    def from_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromPatchArgs']]]]):
        pulumi.set(self, "from_", value)

    @property
    @pulumi.getter
    def to(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToPatchArgs']]]]:
        """
        To describes the resources that may be referenced by the resources
        described in "From". Each entry in this list MUST be considered to be an
        additional place that references can be valid to, or to put this another
    ...
    @to.setter
    def to(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToPatchArgs']]]]):
        pulumi.set(self, "to", value)


if not MYPY:
    class ReferenceGrantSpecToPatchArgsDict(TypedDict):
        """
    ...
    ReferenceGrantSpecToPatchArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ReferenceGrantSpecToPatchArgs:
    def __init__(__self__, *,
                 group: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None):
        ...
        :param pulumi.Input[str] kind: Kind is the kind of the referent. Although implementations may support
               ...
               * Secret when used to permit a SecretObjectReference
               * Service when used to permit a BackendObjectReference
        :param pulumi.Input[str] name: Name is the name of the referent. When unspecified, this policy
               refers to all resources of the specified Group and Kind in the local
               namespace.
        """
        if group is not None:
...
if not MYPY:
    class ReferenceGrantSpecToArgsDict(TypedDict):
        """
        ReferenceGrantTo describes what Kinds are allowed as targets of the
        references.
        """
    ...
    ReferenceGrantSpecToArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    class ReferenceGrantSpecArgsDict(TypedDict):
        """
        Spec defines the desired state of ReferenceGrant.
        """
        from_: NotRequired[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromArgsDict']]]]
        """
        From describes the trusted namespaces and kinds that can reference the
        resources described in "To". Each entry in this list MUST be considered
        to be an additional place that references can be valid from, or to put
        ...
        Support: Core
        """
        to: NotRequired[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToArgsDict']]]]
        """
        To describes the resources that may be referenced by the resources
        described in "From". Each entry in this list MUST be considered to be an
        additional place that references can be valid to, or to put this another
    ...
    ReferenceGrantSpecArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class ReferenceGrantSpecArgs:
    def __init__(__self__, *,
                 from_: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromArgs']]]] = None,
                 to: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToArgs']]]] = None):
        """
        Spec defines the desired state of ReferenceGrant.
        :param pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromArgs']]] from_: From describes the trusted namespaces and kinds that can reference the
               resources described in "To". Each entry in this list MUST be considered
               to be an additional place that references can be valid from, or to put
               this another way, entries MUST be combined using OR.
               
               Support: Core
        :param pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToArgs']]] to: To describes the resources that may be referenced by the resources
               described in "From". Each entry in this list MUST be considered to be an
               additional place that references can be valid to, or to put this another
               way, entries MUST be combined using OR.
    ...
    @property
    @pulumi.getter(name="from")
    def from_(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromArgs']]]]:
        """
        From describes the trusted namespaces and kinds that can reference the
        resources described in "To". Each entry in this list MUST be considered
        to be an additional place that references can be valid from, or to put
    ...
    @from_.setter
    def from_(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecFromArgs']]]]):
        pulumi.set(self, "from_", value)

    @property
    @pulumi.getter
    def to(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToArgs']]]]:
        """
        To describes the resources that may be referenced by the resources
        described in "From". Each entry in this list MUST be considered to be an
        additional place that references can be valid to, or to put this another
    ...
    @to.setter
    def to(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ReferenceGrantSpecToArgs']]]]):
        pulumi.set(self, "to", value)


if not MYPY:
    class ReferenceGrantArgsDict(TypedDict):
        """
        ...
        Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
        """
        spec: NotRequired[pulumi.Input['ReferenceGrantSpecArgsDict']]
elif False:
    ReferenceGrantArgsDict: TypeAlias = Mapping[str, Any]
