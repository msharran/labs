...
class ReferenceGrantSpecFrom(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str group: Group is the group of the referent.
               ...
               Support: Core
        :param str kind: Kind is the kind of the referent. Although implementations may support
...
class ReferenceGrantSpecTo(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str name: Name is the name of the referent. When unspecified, this policy
